  ...
  return <section className="direction-studio" style={{ '--ds-bg': palette.background || '#070709', '--ds-surface': palette.surface || '#121217', '--ds-text': palette.text || '#ffffff', '--ds-accent': palette.accent || '#ff5a47', '--ds-display': fontFamily(typography.display) }}>
    ...
    <div className="direction-studio-grid">
      ...
      <aside className="direction-controls">
        ...
        <section><header><Palette size={18} /><div><strong>Distinct visual treatment</strong><span>Give this delivery its own composition and image finish.</span></div></header><label className="direction-select">Composition<select value={variation.composition || 'quiet'} onChange={event => onDirectionChange('variation', 'composition', event.target.value)}><option value="quiet">Quiet and open</option><option value="split">Split focus</option><option value="layered">Layered depth</option><option value="grid">Structured grid</option><option value="portrait-led">Portrait-led</option><option value="wide-led">Wide-led</option></select></label><label className="direction-select">Image finish<select value={variation.imageTreatment || 'natural'} onChange={event => onDirectionChange('variation', 'imageTreatment', event.target.value)}><option value="natural">Natural colour</option><option value="warm">Warm print</option><option value="contrast">Clean contrast</option><option value="monochrome">Quiet monochrome</option></select></label><label className="direction-select">Caption style<select value={variation.captionTreatment || 'editorial'} onChange={event => onDirectionChange('variation', 'captionTreatment', event.target.value)}><option value="quiet">Quiet</option><option value="editorial">Editorial</option><option value="bold">Bold</option></select></label></section>
