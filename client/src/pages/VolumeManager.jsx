...
import { AlertCircle, ArrowRight, Check, FileUp, Folder, LoaderCircle, Plus, ScanSearch, Send, Users } from 'lucide-react';
...
export default function VolumeManager({ user }) {
  ...
  async function autoAssign() {
    ...
    try {
      const response = await api.post(`/v1/volume-jobs/${active._id}/auto-assign`);
      setMatchReport(response.data.data);
      await openJob(active._id);
