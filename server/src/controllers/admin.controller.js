...
const runtimeConfigPatchSchema = z.object({
  ...
  rateLimits: z.object({ authAttemptsPer15m: z.number().int().min(1).max(1000).optional(), registrationsPerHour: z.number().int().min(1).max(1000).optional(), emailCodesPerHour: z.number().int().min(1).max(1000).optional(), aiJobsPerMinute: z.number().int().min(120).max(10000).optional(), supportTicketsPerHour: z.number().int().min(1).max(100).optional(), publicAccessPer15m: z.number().int().min(600).max(100000).optional(), publicMediaPerHour: z.number().int().min(20000).max(1000000).optional(), uploadsPerHour: z.number().int().min(10000).max(1000000).optional(), clientDeliveryEmailsPerHour: z.number().int().min(100).max(10000).optional(), billingActionsPerHour: z.number().int().min(120).max(10000).optional(), profileUpdatesPerHour: z.number().int().min(120).max(10000).optional(), analyticsEventsPer15m: z.number().int().min(1000).max(100000).optional() }).strict().optional(),
