...
export function defaultRuntimeConfig() {
  return {
    ...
    rateLimits: { authAttemptsPer15m: 30, registrationsPerHour: 10, emailCodesPerHour: 12, aiGenerationsPerHour: 12, supportTicketsPerHour: 8, publicAccessPer15m: 80, mediaPerHour: 700, uploadsPerHour: 650, clientDeliveryEmailsPerHour: 20, billingActionsPerHour: 30, profileUpdatesPerHour: 20 },
    emailTemplates: [
