...
export const clientAnalyticsLimit = limiter(15 * 60 * 1000, 300, 'Too many analytics events were sent from this connection. Please try again later.', 'analyticsEventsPer15m');
