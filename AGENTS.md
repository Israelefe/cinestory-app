...
- Before writing a single line of copy or code, think through:
  1. *Who is the real human reading or using this?* (e.g., A busy portrait photographer in Lagos who just shot an all-day birthday session, or a client excited to see their photos on WhatsApp).
  2. *What is their actual real-world problem?* (e.g., Clients circling faces in WhatsApp screenshots; taking weeks to select photos; awkward Drive links that nobody gets excited about).
...
- **Banned Buzzwords & Tropes:**
  ...
  - *"Demand excellence from proofing to premiere"*
...
## 3. 100% Human-Like, Natural, and Grounded Copy
- **Write like a real human being.** Speak plainly, directly, and with quiet confidence.
- Use words that real photographers and real clients actually use:
  - *"Pick your 15 favorites"* instead of *"Curate your bespoke selection matrix"*.
  - *"No more screenshot circles on WhatsApp"* instead of *"Eliminate asynchronous communication friction"*.
  - *"Send a private link"* instead of *"Deploy a personalized client touchpoint"*.
...
- Check every technical and product claim against how the app actually works:
  ...
  - Do not confuse the proofing stage (unedited client selection) with the premiere stage (final retouched Photo Story).
...
- Understand the real-world environment:
  ...
  - Pricing is in Nigerian Naira (₦20,000/month for Pro, ₦0 for Free).
